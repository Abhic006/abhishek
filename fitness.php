  ...
  <body>
    ...
    <div class="navbar-2">
      ...
      <div class="box">
        <h2>FITNESS</h2>
        <hr></hr>
        <p>Health and Fitness are like the two sides of a coin. One must remain fit in order to maintain good Health. In today’s contemporary world, it has become all the more essential that we maintain our Health and physique. In the following long and short speech on Health and Fitness, we have discussed what it means to be fit and its importance in our lives. The speech on physical Fitness explores the various ways as to how we can make time in our busy schedules to ensure that our Health is not compromised in any way. The informative speech on Fitness given below can prove to be very beneficial for the readers.</p>
      </div>
      <a href="gallery.html"> <div class="fitness">
